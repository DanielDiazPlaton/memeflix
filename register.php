<?php  
    ...
    if(isset($_POST["submitButton"])){
        ...
        $success = $account->register($firstName, $lastName, $username, $email, $email2, $password, $password2); // Le paso
        // los argumentos para la funcion de validacion
...
<head>
    <title>Welcome to Memeflix</title>
    ...
    <div class="signInContainer">
        ...
        <div class="column">
            ...
            <div class="header">
                ...
                <img src="assets/images/memeflix.png" title="Logo" alt="Site Logo">
                <h3>Sign Up</h3>
                <span>to continue to Memeflix</span>
            </div>
            ...
            <form method="POST">
                ...
                <input type="email" name="email2" placeholder="Confirm Email" value="<?php getInputValues("email") ?>" required>
